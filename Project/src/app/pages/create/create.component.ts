...
export class CreateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.form2 = new FormGroup({
      ...
      additionalInformationArm: new FormControl(''),
      additionalInformationEng: new FormControl(''),
      additionalInformationRus: new FormControl(''),
    });
  }
  ...
  form2Submit() {
    ...
    let data = {
      am: this.form2.get('additionalInformationArm').value,
      ru: this.form2.get('additionalInformationRus').value,
      en: this.form2.get('additionalInformationEng').value,
    };

    this.form.append('additionalInformation', JSON.stringify(data));
