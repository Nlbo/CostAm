...
export class MapComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.initMap();
    setTimeout(_ => {
      document.getElementById('ssss') ? document.getElementById('ssss').click() : null;
    }, 1500)
...
// kkkkkkkkkkkkkkkkkkkkkkkkkk
  ...
  setMarkersCommercialArrayPetrolStationSale(map) {
    for (let i = 0; i < this.commercialArrayPetrolStationSale.length; i++) {
      ...
      const markersRed = new google.maps.Marker({
        position: {
          lat: +this.commercialArrayPetrolStationSale[i].lat,
          lng: +this.commercialArrayPetrolStationSale[i].lng
        },
        map: map,
        icon: iconPetrolSale
      });
  ...
  setMarkersCommercialArrayPetrolStationRent(map) {
    for (let i = 0; i < this.commercialArrayPetrolStationRent.length; i++) {
      ...
      const markersRed = new google.maps.Marker({
        position: {
          lat: +this.commercialArrayPetrolStationRent[i].lat,
          lng: +this.commercialArrayPetrolStationRent[i].lng
        },
        map: map,
        icon: iconPetrolSale
      });
  ...
  setMarkersCommercialArrayHydroelectricSale(map) {
    for (let i = 0; i < this.commercialArrayHydroelectricSale.length; i++) {
      ...
      const markersRed = new google.maps.Marker({
        position: {
          lat: +this.commercialArrayHydroelectricSale[i].lat,
          lng: +this.commercialArrayHydroelectricSale[i].lng
        },
        map: map,
  ...
  setMarkersCommercialArrayHydroelectricRent(map) {
    for (let i = 0; i < this.commercialArrayHydroelectricRent.length; i++) {
      ...
      const markersRed = new google.maps.Marker({
        position: {
          lat: +this.commercialArrayHydroelectricRent[i].lat,
          lng: +this.commercialArrayHydroelectricRent[i].lng
        },
        map: map,
  ...
  setMarkersCommercialArrayRestaurantHotelSale(map) {
    for (let i = 0; i < this.commercialArrayRestaurantHotelSale.length; i++) {
      ...
      const markersRed = new google.maps.Marker({
        position: {
          lat: +this.commercialArrayRestaurantHotelSale[i].lat,
          lng: +this.commercialArrayRestaurantHotelSale[i].lng
        },
        map: map,
        icon: iconHotelMotelSale
      });
  ...
  setMarkersCommercialArrayRestaurantHotelRent(map) {
    for (let i = 0; i < this.commercialArrayRestaurantHotelRent.length; i++) {
      ...
      const markersRed = new google.maps.Marker({
        position: {
          lat: +this.commercialArrayRestaurantHotelRent[i].lat,
          lng: +this.commercialArrayRestaurantHotelRent[i].lng
        },
        map: map,
        icon: iconHotelMotelRent
      });
  ...
  setMarkersCommercialArrayRefrigeratorSale(map) {
    for (let i = 0; i < this.commercialArrayRefrigeratorSale.length; i++) {
      ...
      const markersRed = new google.maps.Marker({
        position: {
          lat: +this.commercialArrayRefrigeratorSale[i].lat,
          lng: +this.commercialArrayRefrigeratorSale[i].lng
        },
        map: map,
  ...
  setMarkersCommercialArrayRefrigeratorRent(map) {
    for (let i = 0; i < this.commercialArrayRefrigeratorRent.length; i++) {
      ...
      const markersRed = new google.maps.Marker({
        position: {
          lat: +this.commercialArrayRefrigeratorRent[i].lat,
          lng: +this.commercialArrayRefrigeratorRent[i].lng
        },
        map: map,
  ...
  setMarkersCommercialArraySportComplexSale(map) {
    for (let i = 0; i < this.commercialArraySportComplexSale.length; i++) {
      ...
      const markersRed = new google.maps.Marker({
        position: {
          lat: +this.commercialArraySportComplexSale[i].lat,
          lng: +this.commercialArraySportComplexSale[i].lng
        },
        map: map,
  ...
  setMarkersCommercialArraySportComplexRent(map) {
    for (let i = 0; i < this.commercialArraySportComplexRent.length; i++) {
      ...
      const markersRed = new google.maps.Marker({
        position: {
          lat: +this.commercialArraySportComplexRent[i].lat,
          lng: +this.commercialArraySportComplexRent[i].lng
        },
        map: map,
